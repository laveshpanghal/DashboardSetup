        ...
        <div className="bg-white dark:bg-gray-800">
            <div className="relative px-4 py-6 overflow-hidden sm:px-6 sm:py-8 lg:p-12 xl:p-16">
                ...
                <p className="mt-2 max-w-xl text-base text-gray-400">
                    Get the latest update and posts delivered to your mail!! Subscribe to our Newsletter
                </p>
                <form>
                        ...
                        <form
                            ...
                            <div className=" relative ">
                                <input type="text" id="&quot;form-subscribe-Subscribe"
                                       ...
                                       placeholder="Email" onChange={(e)=>{setTemp(e.target.value)}}/>
                            </div>
                            <button
