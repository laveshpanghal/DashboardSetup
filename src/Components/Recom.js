    ...
    return (
        ...
        <div className="sm:flex flex-wrap justify-center items-center text-center gap-8">
            <div
                ...
                <div className="flex-shrink-0" onClick={()=>{history.push('/pageNotFound')}}>
                    <div
                        className="flex items-center mx-auto justify-center h-12 w-12 rounded-md bg-indigo-500 text-white">
                        <svg width="20" height="20" fill="currentColor" className="h-6 w-6" viewBox="0 0 1792 1792"
            ...
            <div
                className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 py-4 mt-6 sm:mt-16 md:mt-20 lg:mt-24 bg-white shadow-lg rounded-lg dark:bg-gray-800">
                <div className="flex-shrink-0" onClick={()=>{history.push('/pageNotFound')}}>
                    <div
                        className="flex items-center mx-auto justify-center h-12 w-12 rounded-md bg-indigo-500 text-white">
                        <svg width="20" height="20" fill="currentColor" className="h-6 w-6" viewBox="0 0 1792 1792"
